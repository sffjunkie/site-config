...
let
  ...
  listenPort = lib.looniversity.network.serviceHandlerNamedPort config "minio" "listen";
  consolePort = lib.looniversity.network.serviceHandlerNamedPort config "minio" "console";
